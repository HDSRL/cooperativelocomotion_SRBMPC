...
inline void kinEst(const int footForce[4], const int contactIndex[4], double q[18], double dq[18], Eigen::Matrix3d &R) {
    // ================================== //
	// ========= Con Estimator ========== //
	// ================================== //
    int actCon[4] = {0};
...
inline void kinEst_multi(const int footForce[4], const int contactIndex[4], double q[18], double dq[18], Eigen::Matrix3d &R, size_t eachagnum, Eigen::MatrixXd agentinitial) {
    // ================================== //
	// ========= Con Estimator ========== //
	// ================================== //
    int actCon[4] = {0};
	...
	// Because of COM declaration as static array, initial position difference cannot be updated during the procedure
	// for this reason the difference of initial position should be added at the end
	for(size_t i=0; i<2; i++){
		q[i] += agentinitial(eachagnum,i);
	}
};
