...
void HZD_H_mat(hzd_real *pr, const hzd_real *q, const hzd_real *qd);
...
void HZD_dJh_toe0(hzd_real *pr, const hzd_real *q, const hzd_real *qd);

void HZD_dJh_toe1(hzd_real *pr, const hzd_real *q, const hzd_real *qd);

void HZD_dJh_toe2(hzd_real *pr, const hzd_real *q, const hzd_real *qd);

void HZD_dJh_toe3(hzd_real *pr, const hzd_real *q, const hzd_real *qd);
