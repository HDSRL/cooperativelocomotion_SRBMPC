...
void iswiftQp_e_lagrange(const Eigen::MatrixXd P, Eigen::MatrixXd c_e, 
                const Eigen::MatrixXd A, Eigen::MatrixXd b_e, 
                const Eigen::MatrixXd G, Eigen::MatrixXd h_e, double* sol, double* lagrange_multiplier);
void iswiftQp_lagrange(const Eigen::MatrixXd P, double* c, 
                const Eigen::MatrixXd A, double* b, 
                const Eigen::MatrixXd G, double* h, double* sol, double* lagrange_multiplier);
