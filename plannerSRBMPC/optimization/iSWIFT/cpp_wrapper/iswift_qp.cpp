...
void iswiftQp_e_lagrange(const Eigen::MatrixXd P, Eigen::MatrixXd c_e, const Eigen::MatrixXd A, Eigen::MatrixXd b_e, const Eigen::MatrixXd G, Eigen::MatrixXd h_e, double* sol, double* lagrange_multiplier){
    size_t size_c = c_e.rows();
    size_t size_b = b_e.rows();
    size_t size_h = h_e.rows();
    ...
    iswiftQp_lagrange(P,(double*) c, A,b, G,h, sol, lagrange_multiplier);
...
void iswiftQp_lagrange(const Eigen::MatrixXd P, double* c, const Eigen::MatrixXd A, double* b, const Eigen::MatrixXd G, double* h,double* sol, double* lagrange_multiplier){
    int n = P.innerSize();
    int m = G.innerSize();
    int p = A.innerSize();
    ...
    memcpy(sol, myQP->x, n*sizeof(double)); 
    memcpy(lagrange_multiplier, myQP->y, p*sizeof(double)); 
